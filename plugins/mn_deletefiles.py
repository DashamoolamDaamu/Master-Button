...
async def deletemultiplefiles(bot: Client, message: Message):
    ...
    confirm_button = Btn("Yes, Continue !", callback_data=f"confirm_delete_files#{keyword}", color=C.GREEN)
    abort_button   = Btn("No, Abort operation !", callback_data="close_message", color=C.RED)
