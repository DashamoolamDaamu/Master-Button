...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                Btn('𝚂𝚄𝙿𝙿𝙾𝚁𝚃', url=f'https://t.me/{SUPPORT_CHAT}', color=C.BLUE)
            ]]
            ...
            return
        buttons = [[
             Btn(f'ᴏᴛᴛ ᴜᴘᴅᴀᴛᴇs​', url='https://t.me/new_ott_movies3'),
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://mangandi-2-0.onrender.com/Xdgv.mp4",                                               
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup( [ [ Btn('ɢʀᴏᴜᴘ', url='htpps://t.me/mn_movies_group2', color=C.BLUE) ] ] )
                )
