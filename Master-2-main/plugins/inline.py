...
from pyrogram.types import InlineKeyboardMarkup, InlineQueryResultCachedDocument, InlineQuery
...
def get_reply_markup(query):
    buttons = [
        [
            Btn('Search again', switch_inline_query_current_chat=query, color=C.GREEN)
        ]
        ]
